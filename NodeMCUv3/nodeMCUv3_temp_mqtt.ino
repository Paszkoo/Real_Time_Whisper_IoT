...
// WiFi i MQTT
const char* ssid = "PaszkoIP"; // wifi name
const char* password = "ipwifi1357"; // wifi pass
const char* mqtt_server = "a9aa313a.ala.eu-central-1.emqxsl.com"; // mqtt broker server address
