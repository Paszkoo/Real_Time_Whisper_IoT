...
# Konfiguracja MQTT
BROKER_ADDRESS = "a9aa313a.ala.eu-central-1.emqxsl.com"  # Adres brokera MQTT
...
# Wybór trybu działania na podstawie zmiennej DEV
if __name__ == "__main__":
    if DEV:
        print("Uruchamianie w trybie debugowania (GUI).")
        debug_mode()
    else:
        print("Uruchamianie w trybie headless (bez GUI).")
        headless_mode()
